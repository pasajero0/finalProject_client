...
export const URL_API_STORE_CART = `${process.env.REACT_APP_SERVER_URL}/app/store-cart`;
...
export const URL_API_LOGOUT_CUSTOMER = `${process.env.REACT_APP_SERVER_URL}/customers/logout`;
export const URL_API_FETCH_PROFILE = `${process.env.REACT_APP_SERVER_URL}/customers/profile`;
export const URL_API_UPDATE_PROFILE = `${process.env.REACT_APP_SERVER_URL}/customers/profile`;
