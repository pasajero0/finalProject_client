  ...
  <>
    ...
    <div className="container">
     <div className="delivery">
        <h1 className="delivery__header">Shipping & Delivery</h1>
        <div className="delivery__longLine" />
        <h2 className="delivery__header_small">SHIPPING COSTS & DELIVERY OPTIONS</h2>
